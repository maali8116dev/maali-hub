...
**Document purpose:** Technical summary for a partner organization (integrator) connecting their system to MAALI.
...
## 1. Monthly and annual transaction limit
...
**Limits per API key:** 20 requests/minute; 1,000 successful requests/month (2xx only; see §1).
...
### 3.2 What the partner system must support
