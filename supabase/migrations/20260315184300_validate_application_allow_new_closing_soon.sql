-- Allow application submission when opportunity status is new, open, or closing-soon
-- (previously only 'open' was allowed, so "New" and "Closing Soon" opportunities rejected submissions)
...
BEGIN
  ...
  -- (frontend form can save "new" or "closing-soon" if DB allows; we allow submission for all of these)
