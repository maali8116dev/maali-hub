-- ONE-TIME FIX: PostgreSQL has no max(uuid). This migration replaces
-- validate_application_submission to use COUNT + SELECT id LIMIT 1 instead of MAX(id).
-- Run once on any DB that already applied the broken migrations, then DELETE this file.
