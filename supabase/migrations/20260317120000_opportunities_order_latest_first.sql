-- Order opportunities by latest first (created_at DESC) on the opportunities list
-- Recreate get_opportunities_with_filters with ORDER BY created_at DESC, featured DESC
