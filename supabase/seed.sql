-- Seed data for categories and opportunities tables
...
INSERT INTO opportunities (
  title, description, category_id, status, opportunity_type, program_format,
  funding_type, experience_level, deadline, start_date, end_date,
  funding_amount, currency, location, country, organization_name,
...
VALUES
  (
    ...
    'closed', 'grant', 'hybrid', 'equity_free', 'early_stage',
    '2025-12-15', '2026-01-15', '2026-12-15',
    '50000', 'USD', 'Pan-African', 'KE', 'Africa Women in Tech Foundation',
  ...
  (
    ...
    (SELECT id FROM categories WHERE slug = 'fintech' LIMIT 1),
    'open', 'grant', 'in_person', 'equity_free', 'growth',
    '2025-10-20', '2025-11-01', '2026-10-20',
    '75000', 'USD', 'West Africa', 'NG', 'West Africa FinTech Hub',
  ...
  (
    ...
    (SELECT id FROM categories WHERE slug = 'technology' LIMIT 1),
    'open', 'accelerator', 'hybrid', 'equity', 'early_stage',
    '2027-11-30', '2028-01-15', '2028-07-15',
    '100000', 'USD', 'Pan-African', NULL, 'AfriAI Labs',
  ...
  (
    ...
    (SELECT id FROM categories WHERE slug = 'technology' LIMIT 1),
    'open', 'fellowship', 'remote', 'equity_free', 'mid_level',
    '2028-01-15', '2028-03-01', '2029-03-01',
    '40000', 'USD', 'East Africa', 'KE', 'Digital Africa Initiative',
  ...
  (
    ...
    'open', 'grant', 'in_person', 'equity_free', 'early_stage',
    '2027-11-30', '2028-01-01', '2028-12-31',
    '25000', 'USD', 'East Africa', 'TZ', 'East Africa AgriTech Council',
  ...
  (
    ...
    (SELECT id FROM categories WHERE slug = 'agriculture' LIMIT 1),
    'open', 'training', 'hybrid', 'equity_free', 'entry_level',
    '2027-12-20', '2028-02-01', '2028-05-01',
    '60000', 'USD', 'Sub-Saharan Africa', NULL, 'AgriIoT Africa',
  ...
  (
    ...
    (SELECT id FROM categories WHERE slug = 'agriculture' LIMIT 1),
    'open', 'competition', 'in_person', 'equity_free', 'mid_level',
    '2027-10-10', '2027-11-01', '2027-12-15',
    '35000', 'USD', 'West Africa', 'GH', 'West Africa AgriChain Network',
  ...
  (
    ...
    (SELECT id FROM categories WHERE slug = 'fintech' LIMIT 1),
    'open', 'incubator', 'hybrid', 'equity', 'early_stage',
    '2027-12-05', '2028-01-15', '2028-07-15',
    '55000', 'USD', 'Pan-African', NULL, 'MobilePay Africa Hub',
  ...
  (
    ...
    (SELECT id FROM categories WHERE slug = 'fintech' LIMIT 1),
    'open', 'scholarship', 'remote', 'equity_free', 'entry_level',
    '2028-02-28', '2028-04-01', '2029-04-01',
    '80000', 'USD', 'Pan-African', NULL, 'Africa Blockchain Institute',
  ...
  (
    ...
    (SELECT id FROM categories WHERE slug = 'technology' LIMIT 1),
    'open', 'internship', 'remote', 'equity_free', 'entry_level',
    '2027-11-25', '2028-01-10', '2028-07-10',
    '45000', 'USD', 'Pan-African', NULL, 'LearnAfrica Collective',
  ...
  (
    ...
    (SELECT id FROM categories WHERE slug = 'technology' LIMIT 1),
    'open', 'grant', 'hybrid', 'equity_free', 'growth',
    '2027-12-10', '2028-02-01', '2028-12-31',
    '65000', 'USD', 'Pan-African', NULL, 'HealthTech Africa Fund',
  ...
  (
    ...
    (SELECT id FROM categories WHERE slug = 'technology' LIMIT 1),
    'open', 'accelerator', 'in_person', 'equity', 'mid_level',
    '2027-10-15', '2027-12-01', '2028-06-01',
    '90000', 'USD', 'Pan-African', NULL, 'CleanPower Africa',
  ...
  (
    ...
    (SELECT id FROM categories WHERE slug = 'technology' LIMIT 1),
    'open', 'job', 'remote', 'equity_free', 'mid_level',
    '2028-01-30', NULL, NULL,
    '50000', 'USD', 'Pan-African', NULL, 'MoveAfrica Network',
...
SELECT setval('opportunity_tag_map_id_seq', COALESCE((SELECT MAX(id) FROM opportunity_tag_map), 1));
