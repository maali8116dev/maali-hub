...
-- ============================================
-- Insert categories first (required for opportunities.category_id foreign key)
...
-- ============================================
-- STEP 2: Insert Opportunities
-- ============================================
-- Technology Opportunities
INSERT INTO opportunities (
  title, description, category_id, status, opportunity_type, deadline, funding_amount,
  currency, location, country, image_url, requirements, eligibility_criteria, 
...
SELECT setval('opportunities_id_seq', COALESCE((SELECT MAX(id) FROM opportunities), 1), false);
